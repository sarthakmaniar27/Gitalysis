...
ELASTIC_REPO_DATA_FIELDS = ["contributors_url","name","owner.login","owner.organizations_url","commits_url","created_at","issues_url","id","watchers_count","description","forks_count","forks_url","full_name","html_url","languages_url","open_issues_count","owner.avatar_url","owner.html_url","owner.id","tags_url","updated_at", "contributors_list", "issues_list", "languages_list"]
